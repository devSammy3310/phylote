const mostUsedVehicles = [
  {
    ...
    image: [
      { src: "/img/cadillac_escalade.jpg", alt: "armored vehicle" },
  ...
  },
  {
    ...
    image: [
      { src: "/img/Mercedes-s600-guard.jpg", alt: "armored vehicle" },
      { src: "/img/TLC-79DC-Nov-2.jpg", alt: "armored vehicle" },
      { src: "/img/TLC-79SC-Nov3.jpg", alt: "armored vehicle" },
    ],
    name: "Mercedes-Benz S-Guard 600",
    details:
      "Mercedes-Benz S-Guard 600 is one of the most common armored vehicles available for civilians. Although it may look like an ordinary vehicle, it is actually made of highly durable and unbreakable steel and ceramic composite materials. High-quality ballistic glass further enhances its level of protection against all ballistic threats. The S-Guard 600 comes with many safety features. For example, its run-flat technology allows you to keep driving the vehicle up to 80 KM or 50 mph after getting punctured. Similarly, in case of a chemical or tear gas attack, its fresh air system supplies oxygen into the cabin. Its vigorous armor body protects you from explosions and other deadly weapons attacks. The vehicle is common among politicians, celebrities, and business tycoons.",
    features: [
      "V12 twin-turbo engine",
      "Run-flat tire technology (up to 80 KM after puncture)",
      "Ballistic protection (steel and ceramic composite materials)",
      "High-quality ballistic glass",
      "Fresh air system (chemical or tear gas attack protection)",
      "Explosive resistance and protection against deadly weapons",
    ],
    specifications: [
      { spec: "Engine", value: "V12 twin-turbo" },
      { spec: "Horsepower", value: "530 hp" },
      { spec: "Torque", value: "830 Nm" },
